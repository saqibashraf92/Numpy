...
def function6():
    ...
    arr = np.zeros(10,dtype=np.int); arr[4]=10; arr[7]=20;  #wrtie your code here
...
def function8():
    ...
    x = np.ones((2,5),dtype=np.uint32)*6    #write your code here
...
def function11():
    ...
    ans = np.where(arr.copy()%2==1,-1,arr.copy())   #write your code here 
...
def function14():
    ...
    ans = np.split(arr,[2,4,6,8])                #write your code here 
...
def function16():
    ...
    x = np.array([[1], [2], [3]])
    y = np.array([[2], [3], [4]])
    ans = np.split(np.hstack((x,y)),[1,2])  #write your code here 
...
def function18():
    ...
    x = x = (np.intersect1d(piaic,students)).size   # Write you code Here
    return x
